    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <form action={createRecurringIncome} className="mt-5 space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className="grid gap-2 text-sm font-medium">
              ...
              <input
                ...
                required
                placeholder="0,00"
                className="min-h-11 rounded-xl border bg-transparent px-3 font-normal tabular-nums outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))]"
              />
            </label>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
                ...
                <PopoverContent className="w-48">
                  {frequencies.map((item) => (
                    <button
                      key={item.value}
                      type="button"
                      className={`flex w-full items-center rounded-lg px-3 py-2 text-left text-sm ${frequency === item.value ? 'bg-[hsl(var(--surface-muted))] font-medium' : 'hover:bg-[hsl(var(--surface-muted))]'}`}
            ...
            <label className="grid gap-2 text-sm font-medium">
              ...
              <span className="relative">
                ...
                <input
                  ...
                  defaultValue={today}
                  required
                  className="min-h-11 w-full rounded-xl border bg-transparent pl-9 pr-3 font-normal outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))]"
                />
              </span>
            </label>
          </div>
          ...
          <Popover>
            <PopoverTrigger className="text-left text-xs text-[hsl(var(--muted-foreground))] underline underline-offset-4">
              Notas
            </PopoverTrigger>
            <PopoverContent align="start" className="w-[min(22rem,calc(100vw-2rem))] p-3">
              <label className="grid gap-2 text-sm font-medium">
                ...
                <textarea
                  ...
                  className="resize-none rounded-xl border bg-transparent px-3 py-2 font-normal outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))]"
                />
              </label>
            </PopoverContent>
          </Popover>
