          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-[hsl(var(--muted-foreground))]">
                Saldo atual das contas ativas. Compromissos recorrentes aparecem
                separadamente no planeamento.
              </p>
            </div>
        ...
        >
          {[
            ...
            <Link
              key={title as string}
              href={href as string}
              className="rounded-[var(--radius-lg)] border bg-[hsl(var(--surface))] p-4 transition hover:-translate-y-0.5 hover:shadow-sm sm:p-5"
            >
