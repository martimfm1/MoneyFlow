          ...
          <section className="mt-6 grid gap-3 sm:grid-cols-3">
            ...
            <article className="rounded-[var(--radius-lg)] border bg-[hsl(var(--surface))] p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-[hsl(var(--muted-foreground))]">
                Usa estados e prioridades para decidir antes de comprar.
              </p>
            </article>
          </section>
          ...
          <section className="mt-8">
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
              {items.map((item) => (
                <article
                  key={item.id}
                  className="flex min-h-full flex-col rounded-[var(--radius-lg)] border bg-[hsl(var(--surface))] p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                >
