      ...
      <div className="moneyflow-shell py-6 sm:py-10">
        ...
        <section className="mx-auto mt-8 max-w-lg rounded-[var(--radius-lg)] border bg-[hsl(var(--surface))] p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-2 text-sm leading-6 text-[hsl(var(--muted-foreground))]">
            Regista algo que queres comprar para poderes comparar prioridades
            antes de gastar.
          </p>
          {params.error ? (
            <p className="mt-4 rounded-[var(--radius-md)] bg-[hsl(var(--danger)/0.08)] px-3 py-2 text-sm">
              {params.error}
            </p>
          ) : null}
          ...
          <form action={createWishlistItem} className="mt-6 space-y-4">
            <label className="block space-y-2 text-sm font-medium">
              ...
              <input
                ...
                required
                maxLength={120}
                placeholder="Auscultadores, monitor, viagem..."
            ...
            <label className="block space-y-2 text-sm font-medium">
              ...
              <input
                ...
                required
                placeholder="199,99"
                className="min-h-11 w-full rounded-[var(--radius-md)] border bg-transparent px-3 text-lg outline-none"
              />
            </label>
            ...
            <label className="block space-y-2 text-sm font-medium">
              ...
              <textarea
                ...
                maxLength={1000}
                rows={4}
                placeholder="Porque queres isto? Há alternativas?"
                className="w-full rounded-[var(--radius-md)] border bg-transparent px-3 py-2 outline-none"
              />
            </label>
