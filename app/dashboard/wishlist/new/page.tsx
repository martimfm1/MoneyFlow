      ...
      <div className="moneyflow-shell py-6 sm:py-10">
        ...
        <section className="mx-auto mt-8 max-w-3xl rounded-[var(--radius-lg)] border bg-[hsl(var(--surface))] p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[hsl(var(--muted-foreground))]">
            Regista uma compra que estás a considerar. Preço e prioridade são
            suficientes para começares; os restantes dados ajudam a decidir
            melhor.
          </p>
          {params.error ? (
            <p
              role="alert"
              className="mt-4 rounded-[var(--radius-md)] bg-[hsl(var(--danger)/0.08)] px-3 py-2 text-sm"
            >
              {params.error}
            </p>
          ) : null}
