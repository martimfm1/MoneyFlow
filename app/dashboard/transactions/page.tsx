  ...
  return (
    <main className="moneyflow-shell py-6 sm:py-10">
      ...
      <section className="mt-6 rounded-[var(--radius-lg)] border bg-[hsl(var(--surface))] p-4 shadow-sm sm:p-5">
        <form
          className="grid gap-3 lg:grid-cols-[minmax(18rem,1.7fr)_minmax(10rem,1fr)_minmax(10rem,1fr)_auto] lg:items-center"
          method="get"
        >
          ...
          <Link
            ...
            className="text-sm font-medium underline-offset-4 hover:underline lg:col-span-4"
          >
            Gerir categorias
          </Link>
        </form>
          ...
          <div className="divide-y">
            {transactions.map((transaction) => {
              ...
              return (
                <article
                  key={transaction.id}
                  className="grid items-center gap-3 p-4 lg:grid-cols-[auto_minmax(0,1fr)_10rem_8rem_auto] lg:gap-4 lg:px-5"
                >
